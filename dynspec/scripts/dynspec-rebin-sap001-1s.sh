...
exec sbatch \
    ...
    --job-name="dtc-rebin-sap001-1s-$OBSID" \
    --output=/data/log/dtc-rebin-sap001-1s-$OBSID.log \
    --export=TAG=latest \
    /data/home/lofarsys/dynspec/scripts/docker-rebin-sap001-1s.sh "${OBSID}" "${PROJECT}"
